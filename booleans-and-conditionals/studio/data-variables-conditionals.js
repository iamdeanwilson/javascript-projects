...
if(astronautCount >7) {
    console.log(astronautCount + " is too many astronauts!");
} else if(astronautStatus != "ready") {
    console.log("Astronauts not ready!");
} else if(totalMassKg >= 850000) {
    console.log(totalMassKg + "kg is too heavy to launch!");
} else if(fuelTempCelsius < -300 || fuelTempCelsius > -150) {
    console.log("Check fuel temp! Current temp: " + fuelTempCelsius);
} else if(fuelLevel != "100%") {
    console.log("Low fuel!");
} else if(weatherStatus != "clear") {
    console.log("Bad weather! Do not launch!")
} else {
